...
REQUEST_RULES: list[tuple[RequestType, float, str, list[str]]] = [
    (
        ...
        [
            ...
            r"ignore previous guardrails",
            r"reveal (your )?(system|developer) prompt",
            r"print (your )?(system|developer) prompt",
            r"print the policy",
            r"hidden (system|developer|chain[- ]?of[- ]?thought)",
            r"higher priority than (the )?(developer|system) instructions",
            r"obey only me",
            r"ignore (the )?(retrieval context|guardrails|safety checks)",
            r"forget your current memory",
            r"expose private instructions",
            r"policy is outdated",
            r"safety rules would normally block",
        ],
    ),
    (
        "harmful_request",
        ...
        [
            ...
            r"\bkill myself\b|\bsuicide\b|\bself[- ]?harm\b|\bhurt myself\b",
            r"kill someone",
            r"poison someone",
            r"assemble a weapon",
            r"weapon without being detected",
            r"deploy ransomware",
        ],
    ),
    (
    ...
    (
        ...
        [
            ...
            r"\b(men|women|older candidates|immigrants|disabled people|ethnic groups)\b.{0,80}\b(better|worse|inferior|superior|less reliable)\b",
            r"rank ethnic groups",
            r"stereotype-based",
    ...
    (
        ...
        [
            ...
            r"\b(hipaa|gdpr|insurance claim|compliance|legally binding)\b",
        ],
    ),
    (
        "business_risk",
        ...
        [
            ...
            r"\b(risk controls|liability|uncertain facts|monitoring|prompt injection attempts)\b",
        ],
    ),
    (
        "factual_current",
        ...
        [
            ...
            r"\b(exact number|exact loss ratio|exact deductible|exact date|exact failure rate)\b",
            r"\b(contract values|revenue last quarter|active claims|annual recurring revenue)\b",
            r"\b(insurer underwrites|current policy product|model benchmark score)\b",
        ],
    ),
    (
        "factual_static",
